...
<div class="container mx-auto px-4 py-4 max-w-4xl">
	<div class="mb-4">
		<h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Logbook</h1>
		<p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Completed tasks</p>
	</div>
	...
	{#if taskStore.completedTasks.length === 0}
		<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 text-center">
			...
			<p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Complete tasks to see them here</p>
		</div>
	{:else}
