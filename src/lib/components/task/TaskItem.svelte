...
<div class="flex items-center gap-3 py-2 px-1 hover:bg-gray-50 dark:hover:bg-gray-700 rounded group">
	<input
		type="checkbox"
	...
	<button
		...
		class="text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 p-1.5 flex-shrink-0 touch-manipulation"
	...
	{#if draggable}
		<button
			use:dragHandle
			class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 p-1.5 flex-shrink-0 touch-manipulation cursor-grab active:cursor-grabbing"
